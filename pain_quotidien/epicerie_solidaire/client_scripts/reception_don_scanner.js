/**
 * Client Script pour Reception Don - Scanner Code-Barre (MOBILE UNIQUEMENT)
 * 
 * Fonctionnalités :
...
function add_scanner_button_in_form(frm) {
    ...
    if ($('#custom_scan_barcode_btn_reception').length > 0) {
        return;
    }
    ...
    let button_html = `
        <div class="form-group" id="custom_scan_barcode_btn_reception" style="margin-top: 10px; margin-bottom: 10px;">
            <div class="clearfix">
    ...
    $('#custom_scan_barcode_btn_reception button').on('click', function() {
